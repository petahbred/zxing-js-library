...
var BrowserCodeReader = /** @class */ (function () {
    ...
    function BrowserCodeReader(reader, timeBetweenScansMillis, _hints) {
        ...
        this._hints = _hints;
        // for decodeMultiple!
        this.QRCodeReader = new QRCodeReader_1.default();
        /**
    ...
    BrowserCodeReader.prototype.decodeFromImageUrl = function (url) {
        ...
        this.imageElement = element;
        var decodeTask = this._decodeOnLoadImageMultiple(element);
        element.src = url;
        return decodeTask;
    };
    /**
    ...
    BrowserCodeReader.prototype._decodeOnLoadImage = function (element) {
        ...
        return new Promise(function (resolve, reject) {
            _this.imageLoadedListener = function () { return _this.decodeOnce(element, false, false).then(resolve, reject); };
            element.addEventListener('load', _this.imageLoadedListener);
        });
    };
    BrowserCodeReader.prototype._decodeOnLoadImageMultiple = function (element) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.imageLoadedListener = function () { return _this.decodeOnceMultiple(element, false, false).then(resolve, reject); };
            element.addEventListener('load', _this.imageLoadedListener);
        });
    };
    ...
    BrowserCodeReader.prototype.decodeOnceMultiple = function (element, retryIfNotFound, retryIfChecksumOrFormatError) {
        var _this = this;
        if (retryIfNotFound === void 0) { retryIfNotFound = true; }
        if (retryIfChecksumOrFormatError === void 0) { retryIfChecksumOrFormatError = true; }
        this._stopAsyncDecode = false;
        var loop = function (resolve, reject) {
            ...
            try {
                var result = _this.decodeMultiple(element);
                resolve(result);
            }
            catch (e) {
                var ifNotFound = retryIfNotFound && e instanceof NotFoundException_1.default;
    ...
    BrowserCodeReader.prototype.decodeMultiple = function (element) {
        // get binary bitmap for decode function
        var binaryBitmap = this.createBinaryBitmap(element);
    ...
    BrowserCodeReader.prototype.decodeBitmapMultiple = function (binaryBitmap) {
