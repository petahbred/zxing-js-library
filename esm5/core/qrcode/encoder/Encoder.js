...
var Encoder = /** @class */ (function () {
    ...
    Encoder.encode = function (content, ecLevel, hints) {
        ...
        if (hints !== null && hints.has(EncodeHintType_1.default.STRUCTURED_APPEND)) {
            var appendHint = hints.get(EncodeHintType_1.default.STRUCTURED_APPEND);
    ...
    Encoder.appendBytes = function (content, mode, bits, encoding) {
        if (content instanceof Uint8Array) {
            return Encoder.append8BitBytes(content, bits, encoding);
        }
        switch (mode) {
    ...
    Encoder.append8BitBytes = function (content, bits, encoding) {
        if (content instanceof Uint8Array) {
            for (var i = 0, length_2 = content.length; i !== length_2; i++) {
                var b = content[i];
                bits.appendBits(b, 8);
            }
            return;
        ...
        for (var i = 0, length_3 = bytes.length; i !== length_3; i++) {
            var b = bytes[i];
            bits.appendBits(b, 8);
        }
    };
