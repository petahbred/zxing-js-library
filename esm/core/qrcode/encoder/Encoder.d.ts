...
export default class Encoder {
     ...
     *   or configuration
     */
    static encode(content: string | Uint8Array, ecLevel: ErrorCorrectionLevel, hints?: Map<EncodeHintType, any>): QRCode;
    /**
     ...
     */
    static chooseMode(content: string | Uint8Array, encoding?: string): Mode;
     ...
     */
    static appendBytes(content: string | Uint8Array, mode: Mode, bits: BitArray, encoding: string): void;
    ...
    static append8BitBytes(content: string | Uint8Array, bits: BitArray, encoding: string): void;
    /**
