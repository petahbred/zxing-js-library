...
export declare class BrowserCodeReader {
    ...
    */
     ...
     */
    decodeFromImageUrl(url?: string): Promise<Array<Result>>;
    /**
     * Decodes an image from a URL.
     */
    ...
    private _decodeOnLoadImageMultiple;
    ...
    decodeOnceMultiple(element: HTMLVisualMediaElement, retryIfNotFound?: boolean, retryIfChecksumOrFormatError?: boolean): Promise<Array<Result>>;
    /**
    ...
    decodeMultiple(element: HTMLVisualMediaElement): Array<Result>;
    /**
    ...
    decodeBitmapMultiple(binaryBitmap: BinaryBitmap): Array<Result>;
    /**
